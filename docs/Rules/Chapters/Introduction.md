...
In a tactical game, *positioning matters*. So our game is played on a grid. Effects and distances are measured in squares. This means all players are focused on the same problem, and there is no ambiguity regarding where the heroes and villains are in relation to each other. The hobgoblin troopers are setting themselves up in a line to stop our [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) and [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury) from getting into melee with the hobgoblin war mage. We're all aware of what's happening, and we can talk about what we're going to do to stop it.
...
- **Character options are different.** We strongly recommend you start exploring *Draw Steel* by looking through the character creation section before you decide what you want to play. You can't just assume the [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) is "basically a cleric." In some ways, it is! But in other ways, it's quite different. You might have some cool character archetype you love to play in d20 fantasy, and you're dying to see how that might work in *Draw Steel*. But you'll have a lot more fun if you start by browsing the [Ancestries](https://steelcompendium.io/compendium/main-linked/Rules/Chapters/Ancestries) and [Classes](https://steelcompendium.io/compendium/main-linked/Rules/Chapters/Classes) sections and getting inspired. Once you know a bit more about how the game works, you'll have a better handle on how to build your favorite character the *Draw Steel* way.
...
**[Bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding):** A condition that causes a creature to take 1d6 + level damage whenever they use a main action or triggered action, or make a power roll using Might or Agility.
...
**[Burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow):** A movement mode available to creatures with "burrow" in their speed entry, or who gain the capability to temporarily [burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow). Such creatures can move through dirt horizontally at full speed.
...
**[Censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor):** A class for a hero who is a trained warrior devoted to a saint or god.
...
**Clarity:** The [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent)'s Heroic Resource. Unlike other Heroic Resources, clarity can go below 0, leaving a [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) strained.

**Class:** A hero's current role, which largely determines how they interact with the game's rules.

**Claw Dirt:** An ability that uses a maneuver to allow a creature without "burrow" in their speed entry to [burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow).

**[Climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim):** A movement mode that allows a creature to [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) without using additional squares of movement. A creature without "climb" in their speed entry or the temporary ability to [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) must use 2 squares of movement to [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) 1 square.
...
**Condition:** A negative effect that applies to a creature and uses a universal shorthand name. [Bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding), [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed), [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened), [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed), [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained), [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed), [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted), and [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) are conditions in *Draw Steel*.

**[Conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit):** A class for a hero who is the devoted spellcasting priest of a saint or god.
...
**[Crawl](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Crawl):** A movement mode that allows a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature to move. A [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature must use 2 squares of movement to [crawl](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Crawl) 1 square.
...
**Damaging Terrain:** An area of obstacles that deal damage to creatures who are in the area or move through it. A creature can't shift into or out of damaging terrain, and can't [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) out of damaging terrain.

**[Dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed):** A condition that limits a creature to doing only one thing on their turn: use a main action, use a maneuver, or use a move action. A [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) creature also can't use triggered actions, free triggered actions, or free maneuvers.
...
**[Devil](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Devil):** An ancestry from the Seven Cities of Hell.

**Difficult Terrain:** An area of obstacles that are difficult to move through. It costs 1 additional square of movement to enter a square of difficult terrain. A creature can't shift into or out of difficult terrain, and can't [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) out of difficult terrain.

**Dig Maneuver:** A maneuver that allows a creature with "burrow" in their speed entry or the temporary ability to [burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow) to move a number of squares equal to their size vertically through dirt.
...
**Discipline:** The [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null)'s Heroic Resource.
...
**[Dragon Knight](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dragon%20Knight):** An ancestry with a draconic heritage.

**Drama:** The [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour)'s Heroic Resource.

**[Dwarf](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf):** An ancestry with stone skin and short stature.

**Dying:** A state a hero enters when their Stamina is 0 or lower but doesn't reach the negative of their winded value. While dying, a hero is [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) and they can't use the Catch Breath maneuver in combat. A hero dies when their Stamina equals the negative of their winded value.
...
**[Elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist):** A class for a hero mage who wields the elemental forces of the timescape—earth, green, fire, the void, and more.
...
**Escape Grab Maneuver:** A maneuver that allows a [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) creature to make an ability roll to escape.

**Essence:** The [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist)'s Heroic Resource.
...
**Falling:** When a creature falls 2 or more squares, they take 2 damage for each square they fall (to a maximum of 50 damage) and land [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone). A falling creature can reduce the effective height of their fall by a number of squares equal to their Agility score (minimum 0).

**Ferocity:** The [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury)'s Heroic Resource.
...
**[Fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly):** A movement mode available to creatures with "[fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly)" in their speed entry, or who gain the capability to temporarily [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly). Such creatures can move through the air horizontally or diagonally at full speed and remain in midair. If a flying creature is made [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) or has their speed reduced to 0, they fall.

**Focus:** The [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s Heroic Resource.
...
**[Frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened):** A condition that causes a creature to take a bane on ability rolls against the source of their fear. The creature can't willingly move closer to the source of their fear, and that source gains an edge on ability rolls made against the creature.

**[Fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury):** A class for a hero warrior who courses with the ferocity of the Primordial Chaos.

**God:** A deity who grants power to their most devout worshipers through saint intermediaries.

**Grab Maneuver:** A maneuver that allows a creature to make an ability roll to make another creature [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) by them.

**[Grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed):** A condition that reduces a creature's speed to 0 and causes them to take a bane on abilities that don't target the creature, object, or effect that has them [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed).
...
**[Hakaan](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Hakaan):** An ancestry with stone giant blood.
...
**[Hover](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Hover):** A creature who has "[hover](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Hover)" in their speed entry (commonly alongside "[fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly)" or "[teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport)"), or who gains the ability to temporarily [hover](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Hover), can remain motionless in midair. They don't fall even if they are knocked [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) or their speed is reduced to 0.

**[Human](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human):** An ancestry much like [humans](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human) in the real world, except that they can sense magic.

**Humanoid:** Creatures who are of similar size to, have similar limb arrangements as, and have sapience on par with [humans](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human).

**Implement:** A piece of jewelry, a staff, an orb, a wand, or some other object used by a creature to channel supernatural power.

**Insight:** The [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow)'s Heroic Resource.
...
**[Jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump):** A creature can automatically long [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) a number of squares up to their Might or Agility score (their choice). The height of their [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) is automatically 1 square as part of that movement. A creature who wants to [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) farther or higher must make a Might or Agility test.
...
**[Memonek](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Memonek):** An ancestry of machine people.
...
**[Null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null):** A class for a hero who is an unarmed psionic warrior with the ability to dampen supernatural effects.
...
**[Orc](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Orc):** An ancestry of people with magic blood in their glowing veins.

**Orden:** The prime manifold, where [humans](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human), elves, [dwarves](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf), and [orcs](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Orc) share a world with dragons, goblins, kobolds, and dozens of other speaking peoples.
...
**Piety:** The [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit)'s Heroic Resource.

**Pitfall:** A negotiation trait an NPC has that determines what type of arguments will not work on them.

**[Polder](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Polder):** An ancestry of short folk who can slip into shadows to hide.
...
**[Prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone):** A condition that causes a creature to become flat on the ground. Strikes made by a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature take a bane, and melee abilities used against a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature gain an edge.
...
**[Restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained):** A condition that reduces a creature's speed to 0 and prevents them from using the Stand Up maneuver or being force moved.

**Retainer:** A follower who adventures alongside a hero.

**[Revenant](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Revenant):** An undead ancestry. [Revenants](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Revenant) return to the mortal world to complete unfinished business they had in life.
...
**[Sage](https://steelcompendium.io/compendium/main-linked/Rules/Careers/Sage):** A follower who undertakes research projects for a hero.
...
**[Shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow):** A class for a hero who is an expert infiltrator and thief utilizing magic.
...
**[Slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed):** A condition that reduces a creature's speed to 2.
...
**Stand Up Maneuver:** A maneuver that a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature can use to end the [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) condition on themself. Alternatively, a creature can use this maneuver on a willing adjacent [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature to end the [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) condition on them.

**Strained:** A state the [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) enters when they have clarity below 0, and which effects their abilities.
...
**[Swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim):** A movement mode that allows a creature to [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) without using additional squares of movement. A creature without "[swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim)" in their speed entry or the temporary ability to [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) must use 2 squares of movement to [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) 1 square.

**[Tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician):** A class for a hero who is a brilliant strategist and weapons expert.

**[Talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent):** A class for a hero who is a master of psionics.

**[Taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted):** A condition that causes a creature to have a double bane on ability rolls that don't target the creature or effect that [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) them.
...
**[Teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport):** Moving from one location to another instantaneously. Teleporting requires line of effect to the space where a creature ends up, bypasses obstacles, and doesn't provoke opportunity attacks or other effects triggered by moving.
...
**[Time Raider](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Time%20Raider):** An ancestry of four-armed psionic folk with ocular sensors instead of eyes.
...
**[Troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour):** A class for a hero who is a storytelling swashbuckler.
...
**[Walk](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Walk):** The most common movement type, used to move over solid ground. Walking can incorporate ambulating on legs, rolling, slithering, or any other default method of movement.
...
**[Weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened):** A condition that causes a creature to take a bane on power rolls.
...
**Wrath:** The [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor)'s Heroic Resource.
