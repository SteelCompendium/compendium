...
The minimum amount of space a creature can take up during combat is 1 square, but size 1 creatures can run the range from tiny pixies to small [polders](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Polder), medium [humans](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human), and large [hakaan](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Hakaan). As such, for creatures of size 1, that size is further broken down as 1T, 1S, 1M, or 1L—abbreviations for tiny, small, medium, and large. Size 1T is one size smaller than size 1S, two sizes smaller than 1M, three sizes smaller than 1L, and four sizes smaller than size 2. If a mechanic mentions size 1 creatures, that mechanic applies to all creatures of size 1.
...
| ---- | --------------------------------------------------------------- |
| 1T   | Pixie                                                           |
| 1S   | [Polder](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Polder) |
| 1M   | [Human](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human)   |
| 1L   | [Hakaan](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Hakaan) |
| 2    | Ogre                                                            |
| 3    | Shambling mound                                                 |
| 4    | Hill giant                                                      |
| 5    | Omen dragon                                                     |
...
>
> At the Director's discretion, a hero can swap their turn in the order with another willing hero at the start of a new combat round. This allows certain abilities that interact with the core turn order system, such as the [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow)'s Hesitation Is Weakness ability, to better work with this alternative system.
...
Your hero might have one or more unique triggered actions, each of which has a specified trigger that allows the action to be used. You can use one triggered action per round, either on your turn or another creature's turn, but only when the action's trigger occurs. For instance, a [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury) hero can use the Lines of Force triggered action to force move a target, but only after an enemy has first tried to force move the [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury) or another nearby creature.

A free triggered action follows the same rules as a triggered action, but it doesn't count against your limit of one triggered action per round. For instance, a [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) hero can use their Hesitation Is Weakness ability to take their turn in response to the trigger of another hero ending their turn. But because that ability is a free triggered action, the [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) can still use their In All This Confusion triggered action later in the round.
...
Likewise, the nature of an activity might make it too complicated for a free maneuver. For example, picking up the body of an unconscious [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) ally to carry them to safety can probably be done as a free maneuver. But if your Might is lacking and you need to pick up a [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) ally decked out in the Shining Armor kit, the Director might determine that you need to use a regular maneuver to hoist their armored form over your shoulders.
...
Creatures in the game can use eight types of movement: [walk](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Walk), [burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow), [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim), [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim), [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump), [crawl](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Crawl), [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly), and [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport).
...
A creature who has "burrow" in their speed entry, or who gains the temporary ability to [burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow), can move through dirt horizontally, and either has the means to breathe while doing so or doesn't require air to live. Such creatures can't move through more solid ground, such as stone, unless their stat block or the effect that lets them [burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow) says otherwise. Similarly, a burrowing creature doesn't leave a tunnel unless the rules say so.
...
When a creature uses the Dig maneuver, they can move vertically up to a number of squares equal to their size. If a burrowing creature has a creature who is not unconscious [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed), they can't willingly move deeper into the ground. It's too difficult to dig with a flailing enemy in your claws.
...
If a creature who can't [burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow) wants to dig into the ground, they can use the following ability provided their speed is 2 or more.
...
- **≤11:** You can move 1 square into, out of, or through ground you are touching that can be burrowed through, and you are [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) and [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (EoT).
- **12-16:** You can use your main action this turn to move 1 square into, out of, or through ground you are touching that can be burrowed through, and you are [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (EoT).
...
A creature who has "[climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim)" in their speed entry, or who gains the temporary ability to automatically [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim), can [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) across vertical and horizontal surfaces at full speed. Likewise, a creature who has "[swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim)" in their speed entry, or who gains the temporary ability to automatically [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim), can [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) in liquid at full speed.

Creatures without those types of movement can still [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) or [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) when a rule allows them to move, but each square of climbing or swimming costs 2 squares of movement. If a surface is difficult to [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) (for instance, a sheer cliff or ice-covered wall) or a liquid is hard to [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) through (a raging river or whirlpool), the Director can call for a Might test. On a failure, a creature can't [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) or [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) but wastes no movement in the attempt. The Director can also impose other consequences to failure, such as being caught in the spinning current of a whirlpool.
...
Whenever an effect allows you to move (including using the Advance move action), you can automatically long [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) a number of squares up to your Might or Agility score (your choice; minimum 1 square) as part of that movement. The height of your [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) is automatically 1 square as part of that movement.

If you want to [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) even longer or higher than your baseline [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) allows, make a Might or Agility test:

**Power Roll + Might or Agility:**

- **≤11:** You don't [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) any farther than your baseline [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) allows.
- **12-16:** You [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) 1 square longer and higher than your baseline [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) allows.
- **17+:** You [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) 2 squares longer and higher than your baseline [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) allows.

You can't [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) farther or higher than the distance of the effect that allows you to move. You can't [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) out of difficult terrain or damaging terrain (see below).

##### Crawl

If you are [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) (see [Conditions](#page-91-2) in [Chapter 5: Classes](#page-83-2)), you can remain [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and [crawl](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Crawl) on the ground. Doing so costs you 1 additional square of movement for every square you [crawl](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Crawl). If you intentionally want to [crawl](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Crawl), you can fall [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) as a free maneuver. While voluntarily [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), you can choose to stand as a free maneuver.

##### Fly

A creature who has "fly" in their speed entry, or who gains the temporary ability to [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly), can move through the air vertically or horizontally at full speed and remain in midair. If a flying creature is knocked [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) or has their speed reduced to 0, they fall (see [Falling](#page-283-3) below).
...
- A creature teleporting themself must have line of effect to their destination space. A creature teleporting another creature must have line of effect from the space the [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) creature leaves and to their destination space.
- A teleporting creature's destination space can't be occupied by another creature or object.
- The effect that lets a creature [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) indicates how far they can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport). That distance can be greater than the creature's speed.
- If a creature can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) as part of their usual movement, they can use the Advance move action to [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) a number of squares up to their usual speed, unmodified by conditions or effects.
- If a creature teleports while [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), they can be standing when they reach their destination space provided they are able to stand. If a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature is [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) by another creature, it is up to that creature whether the [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) creature remains [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) or stands if they are able.
- If you [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) while affected by the [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) or [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) conditions, those conditions end for you.
- When a creature teleports, they must leave the space where they start and enter a new space. A creature can't [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) to and from the same space.

#### Falling

When a creature falls 2 or more squares and lands on the ground, they take 2 damage for each square they fall (to a maximum of 50 damage) and land [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone). A creature who falls can reduce the effective height of the fall by a number of squares equal to their Agility score (to a minimum of 0). Falling into liquid that is 1 square or more deep reduces the effective height of a fall by 4 squares (to a minimum of 0).
...
A creature can gain this benefit while climbing only if they have "climb" in their speed entry or can automatically [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) at full speed while moving.
...
When you force move a target, you can always move that target fewer squares than the number indicated. For example, when the [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) obtains a tier 3 "push 3" outcome with their Call the Thunder Down ability, they can push targets any distance up to 3 squares, including choosing to not move certain targets at all.
...
If a creature who can't [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly) is left in midair at the end of a vertical forced move, they fall. Forced movement made against a creature who is flying is always a vertical forced move, whether or not the effect specifies it.
...
A creature who is [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) by another creature, an object, or an effect (see [Grab](#page-287-5) below) can attempt to escape by using the following ability.
...
>
> - **≤11:** No effect.
> - **12-16:** You can escape the grab, but if you do, a creature who has you [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) can make a melee free strike against you before you are no longer [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed).
> - **17+:** You are no longer [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed).
>
> **Effect:** You take a bane on this maneuver if your size is smaller than the size of the creature, object, or effect that has you [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed).

See [Conditions](#page-91-2) in [Chapter 5: Classes](#page-83-2) for information on the [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) condition.
...
>
> - **≤11:** No effect.
> - **12-16:** You can grab the target, but if you do, the target can make a melee free strike against you before they are [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed).
> - **17+:** The target is [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) by you.
>
...
A creature can use the Stand Up maneuver to stand up if they are [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), ending that condition. Alternatively, they can use this maneuver to make a willing adjacent [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature stand up.
...
Many rules and abilities allow heroes to make free strikes when it isn't their turn, such as the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s Overwatch ability. As well, all characters can make an opportunity attack free strike.

#### Granted Abilities

Some abilities, such as the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s Strike Now or I'll Open and You'll Close abilities, allow another creature to use a signature ability or heroic ability when it isn't their turn. Unless otherwise stated, a creature can always use a free strike instead of a granted signature ability or heroic ability.
...
Your hero's survivability is represented by your Stamina. Think of Stamina as a combination of a creature's physical vitality and their overall energy for dodging and resisting incoming blows, spells, and other violence. It's not that every instance of damage deals a [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) wound to you, but that each one chips away at your ability to fight effectively. One attack might make you sweat as you leap back to avoid an arrow, while another might graze your elbow with a dagger nick, leaving a dull, distracting pain. Eventually, this draining of energy leaves you open for bigger blows that can truly harm your body—or possibly kill you.
...
While you are unconscious, you can't take main actions, maneuvers, triggered actions, free triggered actions, or free maneuvers; your speed is 0; you are unaware of your surroundings; and you are [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone). Ability rolls against you have a double edge. If you wake up from being unconscious, you can stand up from [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) as a free maneuver.
...
If a creature is fully submerged in water, they have fire immunity 5 and lightning weakness 5. If they can't automatically [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) at full speed while moving, their power rolls take a bane.
...
If the Director calls the end of combat when a specific objective in an encounter is achieved, the event ending creates a big narrative finish. The Director can pick a narrative trigger for an event ending before an encounter begins, or can come up with one on the [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly) if that makes more sense.
