...
In many worlds, at least some cultures have a majority ancestry. The people of Bedegar, a duchy in the region of Vasloria on Orden, are mostly [humans](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human). The folk dwelling in the Great Wode, a forest realm north of Bedegar, are primarily wode elves. However, you can always choose to be from one of these cultures and take a different ancestry. A [dwarf](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf) raised in the culture of the Great Wode speaks Yllyric and probably knows a lot about nature, while a [dwarf](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf) raised in the [dwarf](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf) thanedom of Kal Kalavar speaks Zaliac and might know a good deal about smithing.
...
The languages on the Languages by Ancestry table are the most common languages actively spoken and signed by significant populations of people in Orden. The Vaslorian [Human](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human) Languages table shows the dominant languages in that region's [human](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human)-centric territories. Most languages are associated with a specific ancestry and its culture, but being a member of an ancestry doesn't automatically make you part of the associated culture the language is tied to. For example, if your [orc](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Orc) hero was raised in a culture of elves, you probably speak one of the elf languages, and might never have learned Kalliak.

Most languages have colloquial or casual names. For instance, many people in Orden call Kalliak "Orcish" and Hyrallic "Elvish," but any sage knows there are lots of orcish and elf languages, just as there are multiple [human](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human) languages.
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| Anjali                  | [Devils](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Devil), hobgoblins                                                      | Language of contract law                                                         |
| Axiomatic               | [Memonek](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Memonek)                                                               | Native language of Axiom, and the common<br/> language of the timescape by trade |
...
| Illyvric                | [Shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) elves                                                              |                                                                                  |
| Kalliak                 | [Orcs](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Orc)                                                                      | Offshoot of Zaliac                                                               |
| Kethaic                 | Kobolds                                                                                                                         | Patois of Vastariax and Caelian                                                  |
| Khelt                   | Bugbears, fey                                                                                                                   | Offshoot of Kheltivari                                                           |
| Khoursirian             | [Polder](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Polder), [humans](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human) | Distant offshoot of Khamish                                                      |
...
| Vhoric                  | [Hakaan](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Hakaan)                                                                 | Offshoot of the stone giant dialect of High<br/> Kuric                           |
| Voll                    | Time raiders                                                                                                                    |                                                                                  |
| Yllyric                 | Wode elves                                                                                                                      | Language of druids                                                               |
| Za'hariax               | Overminds                                                                                                                       |                                                                                  |
| Zaliac                  | [Dwarves](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf)                                                                 | Language of engineering                                                          |

##### Language Usage

**Hyrallic** is the primary language of the high elves in Orden. Although young for an elf language, Hyrallic is older than almost all other modern cultural languages, save those of the [dwarves](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf). As a result, while anyone who lives near or trades with a [human](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Human) culture probably speaks at least a little Caelian, most nobles across all [ancestries](https://steelcompendium.io/compendium/main-linked/Rules/Chapters/Ancestries) make sure their children or offspring speak Hyrallic. Caelian is new from many cultures' point of view, while Hyrallic as a language for diplomacy is considered cultured and traditional.
...
Within any document concerning the workings of machines, masonry, or geology, you are likely to find a healthy supply of jargon using **Zaliac**, the most popular [dwarf](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf) language. Even when such texts aren't fully written in Zaliac, they use a lot of [dwarf](https://steelcompendium.io/compendium/main-linked/Rules/Ancestries/Dwarf) language when describing esoteric, complex ideas.
...
The careers in this section don't go into great detail about the actual jobs they represent. We assume that you know the basics of what an [artisan](https://steelcompendium.io/compendium/main-linked/Rules/Careers/Artisan), a [criminal](https://steelcompendium.io/compendium/main-linked/Rules/Careers/Criminal), or a [gladiator](https://steelcompendium.io/compendium/main-linked/Rules/Careers/Gladiator) does for a living. However, each career includes a list of questions you should think about to help you define the specific details of your hero's career. For instance, if you pick the [Artisan](https://steelcompendium.io/compendium/main-linked/Rules/Careers/Artisan) career, one of the questions is: "What did you create?"
...
| 6   | **Ultimate Power:** The mage you worked for was a kindly old soul, but the basic magic they taught you always seemed like a small part of something bigger. It wasn't until you met an adventuring [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist) that you realized hitting the road as a hero was the only way to truly improve and hone your skills. You resigned your apprenticeship and found yourself walking the path of a hero the next day. |
...
**Perk:** One lore perk (*Quick Build:* Expert [Sage](https://steelcompendium.io/compendium/main-linked/Rules/Careers/Sage).)
