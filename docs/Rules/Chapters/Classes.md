...
Your class provides you with many of your features, most of your abilities—your most potent combat moves and noncombat options and a Heroic Resource that fuels many of those abilities. This book presents nine [classes](https://steelcompendium.io/compendium/main-linked/Rules/Chapters/Classes) to choose from.

**[Censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor):** A [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) is a trained warrior devoted to a saint or god. They hunt down the forces of evil using melee weapons and magic granted to them by their divine patron, specializing in confronting the wicked and locking down single enemies during combat.

**[Conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit):** A [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) is the devoted priest of a saint or god. They wield divine magic that smites enemies with holy energy and supports their allies, and are renowned for their healing abilities.

**[Elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist):** An [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist) studies the elemental forces of the timescape and controls earth, fire, the void, and more with magic. Many of their abilities cover wide areas of the battlefield, and they have a versatile array of tricks that allow them to both control combat and manipulate the environment around them when the fight is done.

**[Fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury):** Coursing with the ferocity of the Primordial Chaos in their veins, a [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury) is a mobile warrior who gets up close and personal with enemies to dish out lots of damage. Leaping around the battlefield felling foes and breaking down walls is where the [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury) lives.

**[Null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null):** Disciplined and calm, the [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null) is an unarmed warrior who manifests an aura that quells the supernatural and hinders the offensive prowess of their enemies. They use psionics to make their body stronger than any steel and faster than any steed.

**[Shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow):** Stalking from the darkness, the [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) is an expert assassin and thief who fights equally well in melee and at range as they get the drop on their foes. They utilize magic to help them stay mobile on the battlefield and sneak up on their prey.

**[Tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician):** A brilliant strategist and weapons master, the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) excels at granting allies more movement and actions on the battlefield. They also support allies outside of combat, always inspiring their friends to greatness.

**[Talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent):** A [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) is the master of psionics, manifesting powers that manipulate objects, minds, and time. These heroes can reach far into themselves to use abilities even when they don't have their Heroic Resource to spare—if they're willing to face the cost.

**[Troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour):** A [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) inspires their allies with storytelling and swordplay that is as much an art as it is an act of war. Their quips, songs, poems, and epic tales produce actual magic that harms foes and bolsters allies. They can even use their magic to tweak the campaign's story in real time to better suit their needs.
...
The name and story text for abilities sometimes refers to specific ways in which the ability plays out—particularly combat abilities whose names imply specific types of weapons or tactics. However, that narrative flavor has no effect on how an ability can be used. For example, the [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury)'s Impaled ability allows you to grab a target, setting up the idea of harpooning your monstrous foe with a sword to keep them close. But you can use that ability with an axe, a mace, a hammer, or any other weapon.
...
- The [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor)'s wrath
- The [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit)'s piety
- The [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist)'s essence
- The [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury)'s ferocity
- The [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null)'s discipline
- The [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow)'s insight
- The [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s focus
- The [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent)'s clarity
- The [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour)'s drama
...
Some abilities don't cost your Heroic Resource to use but allow you to spend your Heroic Resource to enhance or add effects to the ability, such as the [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit)'s Healing Grace. These abilities are not heroic abilities unless the baseline ability can't be used without spending your Heroic Resource.
...
If an ability requires a triggered action or a free triggered action to use, a "Trigger" entry is part of the ability. For example, the trigger for the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s Parry ability is: "A creature deals damage to the target." A [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) can use their Parry ability only when that specific triggering event occurs.
...
When an ability can target creatures and objects, the ability can damage objects. However, unless otherwise noted (as with the [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent)'s Minor Telekinesis ability) or if the Director allows it, objects are immune to an ability's other effects. If an ability forces an object to make a test, the object automatically gets a tier 1 result on the test.
...
Using the [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury)'s Brutal Slam ability as an example again, that ability uses a Might power roll and features the following damage expressions in the three tier outcomes of the power roll:

- **≤11:** 3 + M damage
- **12-16:** 6 + M damage
- **17+:** 9 + M damage

For a [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury) with a Might of 2, the ability's damage breakdown would be:
...
Certain ability effects allow you to move and affect other creatures or objects during that move, such as the [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow)'s One Hundred Throats ability. For such abilities, the move begins in the space you first leave when you start the move and ends in the last space you move into.
...
Many abilities and other effects impose conditions and unique statuses on targets. But creatures sometimes get a chance to resist such effects. After all, a monster with a high Might should be harder to knock [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) most of the time than a creature lacking in that characteristic.
...
As an example, consider the [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit)'s Judgment's Hammer ability, which has the following power roll:

**Power Roll + Intuition:**

- **≤11:** 3 + I holy damage; A < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
- **12-16:** 6 + I holy damage; A < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
- **17+:** 9 + I holy damage; A < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)

At 1st level, a [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) uses their Intuition score to determine their potency values, and that score is 2. That gives the [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) the following potencies:

- Weak: 0
- Average: 1
- Strong: 2

When writing Judgment's Hammer on their character sheet, the [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit)'s player updates the damage and converts the weak, average, and strong potencies into their numerical values, knowing that those values won't change until the character hits 2nd echelon and their Intuition score becomes 3. That produces the following:

**Power Roll + Intuition:**

- **≤11:** 5 holy damage; A < 0, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
- **12-16:** 8 holy damage; A < 1, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
- **17+:** 11 holy damage; A < 2, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)

During a game session, the [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) uses Judgment's Hammer to target a bandit with an Agility score of 0. The ability thus has the following outcomes at each tier:
...
Potencies are presented in an abbreviated style in abilities so they don't take up too much space, and so you can read them by saying: "If the target's [characteristic] is less than [potency value], they [suffer effect]." If our 1st-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) obtained a tier 2 outcome when using Judgment's Hammer, the player would say, "I deal 8 holy damage, and if the bandit's Agility is less than 1, they fall [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)."

Reading the ability this way prevents a lot of back and forth. You don't need to ask, "What's the target's Agility score?", wait for a response, and then give the outcome. You can simply say, "If they don't have an Agility of 1 or higher, they fall [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)." Players can let the Director figure out whether the target is [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and keep the game moving, with the Director doing the same in reverse when monsters and other foes use abilities with potencies against the heroes.

##### Adjusting Potencies

Potencies are made for quick resolution at the table, but a number of triggered actions and other abilities—for example, the [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor)'s Judgment ability and the [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null)'s Null Field ability—allow you to manipulate the value of potencies. If you build a hero who can adjust potencies, pay attention during combat! You might be able to help out a friend who needs a little boost to make their ability take full effect, or hinder an enemy about to lock down one of your allies.
...
For example, the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s Overwatch ability allows the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) to spend 1 focus to impose the [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) condition on a target who has R < AVERAGE. Since spending focus this way has no other effect, if the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) targets a creature whose high Reason leaves them unaffected, the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) doesn't waste any focus. However, if spending this focus had another automatic effect such as dealing extra damage to the target, the 1 focus would be spent even though the potency was resisted.
...
Whenever you make an ability roll as a main action and the roll is a natural 19 or natural 20-a total of 19 or 20 before adding your characteristic score or other modifiers—you score a critical hit. A critical hit allows you to immediately take an additional main action after resolving the power roll, whether or not it's your turn and even if you are [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (see [Conditions](#page-91-2) below).

You can't score a critical hit with an ability roll made as a maneuver or any other action type, but you can score a critical hit with a main action you use off your turn. For example, an opportunity attack made as a triggered action or a signature ability used as a free triggered action with the assistance of the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s Strike Now ability can be critical hits.
...
A [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour)'s battle song, a [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury)'s building ferocity, and a [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow)'s patient insight can all make a hero more effective in a fight. These advantages are represented by surges, with many abilities granting heroes surges during a battle.
...
If an ability's effect allows you to take a main action, a maneuver, a move action, or a triggered action, the cost of doing so is subsumed in the ability's type entry on the first line below the flavor text. You never need to spend additional time to use an ability. For example, the [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow)'s Black Ash Teleport ability is a maneuver that allows you to [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) and then use the Hide maneuver as its overall effect. Using the Hide maneuver is part of the maneuver to use the ability, so that you don't need to have another maneuver available to do so.
...
For example, the [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null)'s Null Field ability reduces the potencies of enemies within the field by 1. If two allied [nulls](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null) each have their Null Field ability active and an enemy cultist is targeted by both abilities, that cultist's potencies are reduced by 1, not by 2.

Different effects that impose the same condition (see [Conditions](#page-91-2) below) don't stack to impose the condition twice. For instance, if a hero is targeted by numerous creatures whose abilities cause a target to become [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (imposing a bane on the target's power rolls), the target isn't [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) twice to impose a double bane on those rolls. A character who is [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) by an enemy can't be [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) again by another enemy. The same holds true for game effects that aren't conditions. For example, if a hero is targeted by multiple abilities or effects that can halve their recovery value, the hero's recovery value is halved only once.
...
While a creature is [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding), whenever they use a main action, use a triggered action, or make a test or ability roll using Might or Agility, they lose Stamina equal to 1d6 + their level after the main action, triggered action, or power roll is resolved. This Stamina loss can't be prevented in any way, and only happens once per action.

You take damage from this condition when you use a main action off your turn. For example, a signature ability used as a free triggered action with the assistance of the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s Strike Now ability triggers the damage from the [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) condition.

##### Dazed

A creature who is [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) can do only one thing on their turn: use a main action, use a maneuver, or use a move action. A [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) creature also can't use triggered actions, free triggered actions, or free maneuvers.

##### Frightened

When a creature is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened), any ability roll they make against the source of their fear takes a bane. If that source is a creature, their ability rolls made against the [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) creature gain an edge. A [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) creature can't willingly move closer to the source of their fear if they know the location of that source. If a creature gains the [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) condition from one source while already [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) by a different source, the new condition replaces the old one.

##### Grabbed

A creature who is [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) has speed 0, can't be force moved except by a creature, object, or effect that has them [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed), can't use the Knockback maneuver (see [Maneuvers](#page-287-0) in [Chapter 10: Combat](#page-288-0)), and takes a bane on abilities that don't target the creature, object, or effect that has them [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed). If a creature is [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) by another creature and that creature moves, they bring the [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) creature with them. If a creature's size is equal to or less than the size of a creature they have [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed), their speed is halved while they have that creature [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed).

A creature who has another creature [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) can use a maneuver to move the [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) creature into an unoccupied space adjacent to them.

A creature can release a creature they have [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) at any time to end that condition (no action required). A [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) creature can attempt to escape being [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) using the Escape Grab maneuver (see [Chapter 10: Combat](#page-288-0)). If a [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) creature teleports, or if either the [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) creature or the creature grabbing them is force moved so that both creatures are not adjacent to each other, that creature is no longer [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed).
...
While a creature is [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), they are flat on the ground, any strike they make takes a bane, and melee abilities used against them gain an edge. A [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature must [crawl](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Crawl) to move along the ground, which costs 1 additional square of movement for every square crawled. A creature can't [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim), [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump), [swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim), or [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly) while [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone). If they are climbing, flying, or jumping when knocked [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), they fall.

Unless the ability or effect that imposed the [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) condition says otherwise, a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature can stand up using the Stand Up maneuver (see [Maneuvers](#page-287-0) in [Chapter 10: Combat](#page-288-0)). A creature adjacent to a willing [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) creature can likewise use the Stand Up maneuver to make that creature stand up.

##### Restrained

A creature who is [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) has speed 0, can't use the Stand Up maneuver, and can't be force moved. A [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) creature takes a bane on ability rolls and on Might and Agility tests, and abilities used against them gain an edge.

If a creature teleports while [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained), that condition ends.

##### Slowed

A creature who is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) has speed 2 unless their speed is already lower, and they can't shift.

##### Taunted

A creature who is [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) has a double bane on ability rolls for any ability that doesn't target the creature who [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) them, as long as they have line of effect to that creature. If a creature gains the [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) condition from one source while already [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) by a different source, the new condition replaces the old one.

##### Weakened

A creature who is [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) takes a bane on power rolls.
...
For example a 6th-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) has "Signature, 3, 5, 7, 9" in their Abilities column, and "5, 9" in their Order Abilities column (representing the [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor)'s subclass). This means a [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) of that level has a signature ability and four heroic abilities costing 3, 5, 7, and 9 wrath respectively, plus an additional two subclass heroic abilities costing 5 and 9 wrath.
...
Demons and deathless fear you. Criminals run from the sight of your [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow). Agents of chaos, blasphemers, and heretics tremble at the sound of your voice. You carry the power of the gods, armed with wrath and sent out into the world first to seek, then [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) those whose actions—or even existence—are anathema to your church.

As a [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you're at your best against the strongest foes. Your judgment terrifies heretics, stops enemies in their tracks, and even hurls them across the battlefield.
...
| ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | -------------------- |
| 1st   | [Censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) Order, Deity and Domains, Wrath, Judgment, Kit, My Life for Yours, Domain Feature, [Censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) Abilities | Signature, 3, 5           | -                    |
...
Your [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) order is your subclass, and your choice of order determines many of the features you'll gain as you gain new levels.
...
The power you serve grants you a Heroic Resource called wrath, fueling your abilities as you [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) those your church deems to be heretics.
...
> | **📏 Ranged 10**  | **🎯 One enemy** |
>
> **Effect:** The target is judged by you until the end of the encounter, you use this ability again, you willingly end this effect (no action required), or another [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) judges the target.
>
...
> - If you damage a creature judged by you with a melee ability, the creature is [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) by you until the end of their next turn.
>
...
- **Exorcist:** You can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to a number of squares equal to twice your Presence score. This movement must take you closer to the judged creature. You do not need line of effect to your destination.
...
>
> **Spend 1 Wrath:** You can end one effect on the target that is ended by a saving throw or that ends at the end of their turn, or a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) target can stand up.

#### 1st-Level Domain Feature

You gain a domain feature from your domain, as shown on the 1st-Level [Censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) Domain Features table. Additionally, you gain a skill from your domain, chosen from the skill group indicated on the table.
...
> **Power Roll + Might:**
>
> - **≤11:** 2 + M holy damage; P < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 5 + M holy damage; P < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 7 + M holy damage; P < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
...
> **Power Roll + Presence:**
>
> - **≤11:** 5 + P holy damage; I < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 8 + P holy damage; I < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 11 + P holy damage; I < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 6 + M holy damage; [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
> - **12-16:** 9 + M holy damage; [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
> - **17+:** 13 + M holy damage; [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
>
> **Effect:** If the target makes a strike against a creature while [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) this way, you can spend 3 wrath to deal holy damage to them equal to your Presence score, then change the target of the strike to another target within the strike's distance.
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M holy damage; if the target has P < WEAK, each enemy within 2 squares of them is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you (save ends)
> - **12-16:** 5 + M holy damage; if the target has P < AVERAGE, each enemy within 2 squares of them is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you (save ends)
> - **17+:** 8 + M holy damage; if the target has P < STRONG, each enemy within 2 squares of them is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you (save ends)
>
> **Effect:** Each enemy [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) this way is pushed up to 2 squares away from the target and takes psychic damage equal to your Presence score.
...
As a 2nd-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you gain the following features.
...
> **Power Roll + Might:**
>
> - **≤11:** 8 + M holy damage; P < WEAK, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** 12 + M holy damage; P < AVERAGE, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** 15 + M holy damage; P < STRONG, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
>
> **Effect:** If the target is already [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you or another creature and this ability would frighten them again, they instead take psychic damage equal to twice your Presence score.
...
> **Power Roll + Presence:**
>
> - **≤11:** 5 + P damage; P < WEAK, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 9 + P damage; P < AVERAGE, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 12 + P damage; P < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
>
> **Effect:** While the target is [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) this way, your abilities that impose forced movement can still move them.

### 3rd-Level Features

As a 3rd-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you gain the following features.

#### Look On My Work and Despair

Your judgment has grown in divine power, instilling fear in those you condemn. Whenever you use your Judgment ability, you can spend 1 wrath, and if the target has P < AVERAGE, they are [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you (save ends). Additionally, whenever a creature judged by you is reduced to 0 Stamina and you use Judgment as a free triggered action, if the new target has P < STRONG, they are [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you (save ends). If the target is already [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you, they instead take holy damage equal to twice your Presence score.
...
As a 4th-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you gain the following features.
...
You gain a domain feature from your domain, as shown on the 4th-Level [Censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) Domain Features table.
...
> | **📏 Ranged 10** | **🎯 Self or one ally** |
>
> **Effect:** The target ends any condition or effect on them that is ended by a saving throw or that ends at the end of their turn, or a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) target can stand up. The target then gains 2 surges, can shift up to their speed while ignoring difficult terrain, and can use a strike signature ability as a free triggered action.
...
>
> **Effect:** A target can end one effect on them that is ended by a saving throw or that ends at the end of their turn, or a [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) target can stand up.
...
As a 6th-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you gain the following features.
...
- Any creature struck by the weapon who has holy weakness and has P < STRONG is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) and [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends).
...
- The weapon's wielder can't be made [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened).
...
Your [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) order grants your choice of one of two heroic abilities.
...
> **Power Roll + Presence:**
>
> - **≤11:** Slide 3; I < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** Slide 5; I < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** Slide 7; I < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
...
As a 7th-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you gain the following features.
...
You gain a domain feature from your domain, as shown on the 7th-Level [Censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) Domain Features table.
...
As an 8th-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you gain the following features.
...
Your [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) order grants you a feature, as shown on the 8th-Level Order Features table.
...
> **Power Roll + Might:**
>
> - **≤11:** 9 + M damage; I < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 13 + M damage; I < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 18 + M damage; I < STRONG, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
> **Effect:** At the end of each of your turns, a target [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) this way deals holy damage equal to twice your Presence score to each enemy within 2 squares of them. Additionally, a target [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) this way can't be targeted by their allies' abilities.
...
> **Power Roll + Might:**
>
> - **≤11:** 9 + M damage; I < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 13 + M damage; I < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 18 + M damage; I < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
>
> **Effect:** At the end of each of your turns, a target [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) this way deals holy damage equal to twice your Presence score to each enemy within 2 squares of them.
...
> **Power Roll + Presence:**
>
> - **≤11:** 5 + P damage; I < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 9 + P damage; I < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 12 + P damage; I < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
>
> **Effect:** While the target is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) this way, each of their allies who starts their turn within 5 squares of them must use a free maneuver to make a free strike against the target. Additionally, while the target is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) this way, each of their allies within 5 squares of them who can make a triggered free strike against a different creature must make the free strike against the target instead.

### 9th-Level Features

As a 9th-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you gain the following features.
...
> **Power Roll + Presence:**
>
> - **≤11:** 7 + P psychic damage; P < WEAK, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** 10 + P psychic damage; P < AVERAGE, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** 13 + P psychic damage; P < STRONG, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
>
> **Effect:** While [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) this way, if a target who is a leader or solo creature is winded, they take an extra 25 psychic damage. If a target [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) this way is not a leader or solo creature and is winded, they are reduced to 0 Stamina.
...
As a 10th-level [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor), you gain the following features.
...
You are the ultimate representation of your god's justice in the timescape. Whenever you use your Judgment ability, you can use a free triggered action to use a [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) domain effect (see [Domain Piety and Effects](#page-110-0) in the [Conduit](#page-108-0) section) associated with your chosen domain, or a domain you access with virtue (see below). If the effect calls for the use of your Intuition score, you use your Presence score instead. If the effect uses your [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) level, use your [censor](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Censor) level instead.
...
**As a [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you heal and buff your allies, and debuff your foes while smiting them with divine magic. The spark of divinity within you shines, filling your enemies with awe and making you more worldly and aware.**
...
As a [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
- **Prayer Effect:** You slide one creature within 10 squares of you up to a number of squares equal to 5 + your [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) level.
...
Choose one of your domains. You gain a domain feature for that domain, as shown on the 1st-Level [Conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) Domain Features table. Additionally, you gain a skill from the chosen domain, selected from the skill group indicated on the table. (*Quick Build:* Revitalizing Ritual and the Heal skill from the Life domain.)
...
> - A [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) target can stand up.
...
> - **17+:** 5 holy damage
>
> **Effect:** You can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) yourself and each ally in the area to unoccupied spaces in the area.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 6 + I holy damage; I < WEAK, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** 9 + I holy damage; I < AVERAGE, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** 13 + I holy damage; I < STRONG, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
...
>
> **Effect:** Each target can spend a Recovery. Additionally, each target can use a free triggered action to end one effect on them that is ended by a saving throw or that ends at the end of their turn, or to stand up if [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone).

### 2nd-Level Features

As a 2nd-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
Choose one of your domains. You gain a heroic ability from that domain, as shown on the 2nd-Level [Conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) Domain Abilities table.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 2 damage; A < WEAK, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 3 damage; A < AVERAGE, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 7 damage; A < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
...
As a 3rd-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 6 psychic damage; I < WEAK, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** 9 psychic damage; I < AVERAGE, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** 13 psychic damage; I < STRONG, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
>
> **Effect:** Each target is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you or a creature you choose within distance.
...
As a 4th-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
Choose one of your domains. You gain a domain feature for that domain, as shown on the 4th-Level [Conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) Domain Features table.
...
As a 5th-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 4 corruption damage; I < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)
> - **12-16:** 7 corruption damage; I < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)
> - **17+:** 11 corruption damage; I < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)
...
As a 6th-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
Choose one of your domains. You gain a heroic ability from that domain, as shown on the 6th-Level [Conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) Domain Abilities table.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 8 + I damage; A < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 12 + I damage; A < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 16 + I damage; A < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
...
> | **📏 4 burst**  | **🎯 Self and each ally in the area** |
>
> **Effect:** Each target can spend any number of Recoveries. Additionally, each target can end one effect on themself that is ended by a saving throw or that ends at the end of their turn, or they can stand up if [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone).
...
> **Power Roll + Intuition:**
>
> - **≤11:** 5 damage; M < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)
> - **12-16:** 8 damage; M < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)
> - **17+:** 11 damage; M < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)
...
> **Power Roll + Intuition:**
>
> - **≤11:** 9 + I corruption damage; R < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 14 + I corruption damage; R < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 19 + I corruption damage; R < STRONG, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
> **Effect:** If this damage kills the target, you and each ally within distance can spend a Recovery.

### 7th-Level Features

As a 7th-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
Choose one of your domains. You gain a domain feature for that domain, as shown on the 7th-Level [Conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) Domain Features table.
...
As an 8th-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
As a 9th-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
Choose one of your domains. You gain a heroic ability from that domain, as shown on the 9th-Level [Conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit) Domain Abilities table.
...
> | **📏 Ranged 10**  |  **🎯 Special** |
>
> **Effect:** You conjure a size 4 dragon that appears in an unoccupied space within distance. The dragon has speed 6 and can [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly), stability 4, 100 Stamina, immunity all to fire damage, and uses your characteristics. The dragon disappears at the end of the encounter, if their Stamina drops to 0, or if you are dying.
>
...
> **Power Roll + Intuition:**
>
> - **≤11:** 10 + I damage; A < WEAK, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 15 + I damage; A < AVERAGE, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 21 + I damage; A < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
>
> **Effect:** While [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) this way, the target takes 10 damage at the start of each of your turns.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 10 + I corruption damage; A < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 15 + I corruption damage; A < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 21 + I corruption damage; A < STRONG, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
> **Effect:** While [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) this way, the target has damage weakness 10.

### 10th-Level Features

As a 10th-level [conduit](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Conduit), you gain the following features.
...
**As an [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you can unleash your wrath across a field of foes, debilitate enemies, ward yourself and allies, manipulate terrain, warp space, and more. Your elemental specialization determines which of these talents you excel at.**
...
As a 1st-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
> - You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to a number of squares equal to your Reason score. If you choose this option, you can spend essence to [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) 1 additional square for each essence spent.
...
>
> **Effect:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) the target up to a number of squares equal to your Reason score. If the target moves to trigger this ability, you can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) them at any point during the move.
>
> **Spend 1 Essence:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) the target up to a number of squares equal to twice your Reason score instead.
...
>
> **Effect:** You can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to a number of squares equal to your Reason score.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 + R corruption damage; R < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 4 + R corruption damage; R < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 6 + R corruption damage; R < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
...
> - **≤11:** 3 damage
> - **12-16:** 5 damage
> - **17+:** 8 damage; M < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
>
...
As a 2nd-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
| Fish                  | 2nd   | 0                 | 5 ([swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) only) | 1T   | +0              | +0/+0/+0           | You can breathe in water but can't breathe outside of it.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Rodent                | 2nd   | 0                 | 5 ([climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim))     | 1T   | +0              | +0/+0/+0           | You gain an edge on tests that involve smell.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Bird                  | 3rd   | 0                 | 5 ([fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly))                     | 1T   | +0              | +0/+0/+0           | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Great cat             | 3rd   | 5                 | 6 ([climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim))     | 2    | +0              | +1/+1/+1           | As a maneuver, you can [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) up to 3 squares in any direction. If you land on<br/> an enemy of your size or smaller, that enemy is knocked [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), and you can<br/> make a melee free strike against them (no action required).                                                                                                                                                |
| Giant frog            | 4th   | 5                 | 5 ([swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim))      | 2    | +0              | +0/+0/+0           | Your melee free strike has a distance of melee 3. When you take the Advance<br/> move action, you can high [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) or long [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) up to half your speed. This<br/> [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) can allow you to move more squares than your speed.                                                                                                     |
...
| Mohler                | 4th   | 0                 | 7 ([burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow))               | 1S   | +1              | +0/+0/+0           | Your melee distance gains a +1 bonus.                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Bear                  | 5th   | 10                | 5 ([climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim))     | 2    | +1              | +2/+2/+2           | Your melee distance gains a +1 bonus.                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Giant bird            | 5th   | 0                 | 7 ([fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly))                     | 2    | +0              | +1/+1/+1           | After making a melee free strike, you can shift up to 3 squares as a free<br/> triggered action.                                                                                                                                                                                                                                                                                                                                                                                          |
| Giant<br/> salamander | 6th   | 5                 | 5                                                                               | 1L   | +3              | +2/+2/+2           | Your melee free strike deals fire damage. Additionally, you have fire immunity<br/> 3.                                                                                                                                                                                                                                                                                                                                                                                                    |
| Giant spider          | 6th   | 0                 | 5 ([climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim))     | 2    | +0              | +0/+1/+2           | You have a double edge on melee free strikes against creatures you are hidden<br/> from.                                                                                                                                                                                                                                                                                                                                                                                                  |
| Giant snake           | 7th   | 5                 | 5                                                                               | 3    | +0              | +0/+1/+2           | Whenever you obtain a tier 2 or tier 3 outcome on a melee free strike, you<br/> can automatically grab the target. While [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) this way, the target takes 2<br/> damage at the start of each of their turns.                                                                                                                                                                                                                  |
| Kangaroo              | 7th   | 0                 | 7                                                                               | 1L   | +1              | +0/+0/+4           | When you score a critical hit with a melee free strike, the target is [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save<br/> ends). When you take the Advance move action, you can high [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) or long<br/> [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) up to half your speed. This [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) can allow you to move more squares<br/> than your speed. |
...
| Shark                 | 8th   | 0                 | 8 ([swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) only) | 2    | +0              | +2/+2/+2           | You can breathe in water but can't breathe outside of it. Additionally, you gain<br/> an edge on strikes against targets who are [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) or winded.                                                                                                                                                                                                                                                                           |
| Giant octopus         | 9th   | 5                 | 5 ([swim](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim))      | 3    | +2              | +0/+0/+0           | You can breathe in water. Additionally, you can target two creatures or objects<br/> with your melee free strike. Whenever you obtain a tier 2 or tier 3 outcome on<br/> a melee free strike, you can automatically grab the target. You can have up to<br/> eight creatures [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed).                                                                                                                                           |
...
> | **📏 Ranged 10**              | **🎯 Self or one ally** |
>
> **Effect:** The target is [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) to another space within distance. Make a power roll that affects each enemy adjacent to the target's new space.
>
> **Power Roll + Reason:**
>
> - **≤11:** 3 fire damage
...
> **Power Roll + Reason:**
>
> - **≤11:** 5 + R fire damage; A < WEAK, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 9 + R fire damage; A < AVERAGE, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 12 + R fire damage; A < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)

### 3rd-Level Features

As a 3rd-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
As a 4th-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
As a 5th-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
Additionally, whenever you use a void ability, you or one ally within distance of the ability can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) a number of squares equal to your Reason score.

##### Smoldering Step

You can use 1 square of movement to [walk](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Walk) into an area of fire your size or larger and [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) to any other area of fire your size or larger within 10 squares of the first area.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 corruption damage; A < WEAK, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 3 corruption damage; A < AVERAGE, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 5 corruption damage; A < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
>
> **Effect:** The area is difficult terrain until the start of your next turn. Each enemy who ends their turn in the area is [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends).
>
> **Persistent 1:** The area remains until the start of your next turn.

### 6th-Level Features

As a 6th-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
> | **📏 Ranged 10**                     | **🎯 Self or one ally** |
>
> **Effect:** The target has a +3 bonus to speed, they can [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly), and their abilities ignore concealment. Additionally, whenever the target gains their Heroic Resource, they gain 1 additional Heroic Resource. This effect lasts until the start of your next turn.
>
> **Persistent 1:** The effect lasts until the start of your next turn.
...
> **Power Roll + Reason:**
>
> - **≤11:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) the target up to 4 squares.
> - **12-16:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) the target up to 6 squares.
> - **17+:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) the target up to 8 squares.
>
> **Effect:** If the target is [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) to a space where they would fall, they immediately do so, treating the fall as if their Agility score were 0. The target takes fire damage from the fall, and each enemy within 3 squares of where they land takes the same amount of fire damage. The ground within 3 squares of where the target lands is difficult terrain.
...
As a 7th-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
As an 8th-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
> | **-**<br/> Immunities | **[Burrow](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Burrow)**<br/> Movement |                     | **-**<br/> With Captain | **-**<br/> Weaknesses  |
...
> **Power Roll + Reason:**
>
> - **≤11:** M < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **12-16:** M < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **17+:** M < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
>
> **Effect:** You create a fissure in the ground adjacent to you that is a 10 x 2 line and 6 squares deep. Each creature in the area who is [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and size 2 or smaller falls in. Other creatures can enter the fissure or can shift to the nearest unoccupied space of their choice outside it.

### 9th-Level Features

As a 9th-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
> **Power Roll + Reason:**
>
> - **≤11:** 13 + R fire damage; I < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 18 + R fire damage; I < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 25 + R fire damage; I < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
>
> **Effect:** This damage ignores immunity.

### 10th-Level Features

As a 10th-level [elementalist](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Elementalist), you gain the following features.
...
**As a [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you devastate foes with overwhelming might, hurl yourself and enemies around the battlefield, and grow stronger as your ferocity increases. Nature has no concept of fairness—and neither do you.**
...
As a 1st-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
> **Where's My Maneuver?**
>
> Since most other [classes](https://steelcompendium.io/compendium/main-linked/Rules/Chapters/Classes) get a bespoke maneuver, you might find yourself asking, "Where's the special maneuver for the [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury)?" The answer is that the class doesn't need its own maneuver, because most of the time, the fantasy of the [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury) has them using the Grab or Knockback maneuvers in combat. They're really good at those maneuvers too, so it doesn't make sense to give you another option that you'll rarely or never use.
...
You can use and gain the benefits of a kit. See Chapter 6: Kits for more information. (*Quick Build:* [Panther](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Panther).)
...
You can't obtain lower than a tier 2 outcome on any Might test made to [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) (see Movement Types in Chapter 10: Combat).
...
> - **≤11:** 2 + M damage
> - **12-16:** 5 + M damage
> - **17+:** 7 + M damage; A < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
>
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M damage; M < WEAK, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
> - **12-16:** 5 + M damage; M < AVERAGE, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
> - **17+:** 8 + M damage; M < STRONG, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
>
> **Effect:** While [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) this way, the target takes damage equal to your Might score at the end of each of your turns.
...
> **Power Roll + Might:**
>
> - **≤11:** 4 + M damage; M < WEAK, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) and [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 6 + M damage; M < AVERAGE, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) and [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 10 + M damage; M < STRONG, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) and [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
...
As a 2nd-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
Whenever you use the Charge main action, you can use a strike signature ability or a strike heroic ability instead of a free strike. Additionally, you can [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) as part of your charge.
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M damage; P < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) and [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** 5 + M damage; P < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) and [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** 8 + M damage; P < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) and [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 2 damage; A < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 4 damage; A < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 6 damage; A < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 4 damage; I < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 6 damage; I < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 10 damage; I < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
>
...
> **Power Roll + Might:**
>
> - **≤11:** 2 damage; push 1; M < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 5 damage; push 2; M < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 7 damage; push 3; M < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
>
> **Effect:** This ability deals your primordial damage type (see Stormwight Kits).

### 3rd-Level Features

As a 3rd-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter or until you are dying, each enemy who starts their turn adjacent to you and has P < STRONG is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) until the end of their turn.
...
As a 4th-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
As a 5th-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
> **Power Roll + Might:**
>
> - **≤11:** 10 + M damage; M < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 14 + M damage; M < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 20 + M damage; M < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
>
> **Effect:** While [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) this way, the target takes 1 damage for every square they move, including from forced movement.
...
> **Power Roll + Might:**
>
> - **≤11:** 9 + M damage; M < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 13 + M damage; M < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 18 + M damage; M < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
>
> **Effect:** While the target is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) this way, any other effect that would make the target [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) instead makes them [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) by this ability. Additionally, a creature who fails the saving throw while [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) this way is petrified until they are given a supernatural cure or you choose to reverse the effect (no action required).

### 6th-Level Features

As a 6th-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
As a main action, you can touch a magic source of elemental power and use it to create a portal to Quintessence. You can then use a main action to [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) yourself and any willing creatures within 10 squares of you through the portal and onto a safe island in Quintessence, or to [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) back again. You can maintain a number of portals equal to your Might score, each leading to the same safe island in Quintessence. If a portal in your network is destroyed, it is no longer part of the network. You can remove a portal from your network no matter your distance from it, including across different worlds (no action required).
...
> **Power Roll + Might:**
>
> - **≤11:** 4 + M damage; P < WEAK, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** 6 + M damage; P < AVERAGE, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** 10 + M damage; P < STRONG, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
>
> **Effect:** If a target who is not a leader or solo creature is winded by this strike, they are reduced to 0 Stamina and you choose an enemy within 5 squares of you. If that enemy has P < AVERAGE, they are [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you (save ends).
...
> **Power Roll + Might:**
>
> - **≤11:** 8 damage; M < WEAK, [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
> - **12-16:** 13 damage; M < AVERAGE, [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
> - **17+:** 17 damage; M < STRONG, [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
>
> **Effect:** You can shift up to 4 squares, bringing the target with you. While [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) this way, the target takes damage equal to twice your Might score at the start of each of your turns.
...
As a 7th-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
As an 8th-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
As a 9th-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
As a 10th-level [fury](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Fury), you gain the following features.
...
When any elemental or any other creature whose abilities deal acid, cold, corruption, fire, lightning, poison, or sonic damage first becomes aware of you in combat, if they have P < STRONG, they are [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of you (save ends).
...
**As a [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you resist the supernatural forces of the universe with composure and confidence. As you strive for perfect order, you are an enemy of the ultimate expression of chaos: the supernatural. Those who break the laws of nature using sorcery or psionics should fear you.**
...
Your [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null) tradition is your subclass, and your choice of tradition determines many of the features you'll gain as you gain new levels.
...
> **Power Roll + Agility:**
>
> - **≤11:** 4 + A damage; I < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) and [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 5 + A damage; I < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) and [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 7 + A damage; I < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) and [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 8 + **A** psychic damage; M < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 12 + **A** psychic damage; M < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 16 + **A** psychic damage; M < STRONG, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
> **Effect:** While [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) this way, the target takes damage equal to your Intuition score whenever they use a supernatural ability that costs Malice.
...
>
> **Effect:** A target who goes out of phase is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed), has their stability reduced by 2, and can't obtain a tier 3 outcome on ability rolls.
...
As a 2nd-level [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you gain the following features.
...
Your [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null) tradition grants you a feature, as shown on the 2nd-Level Tradition Features table.
...
Your [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null) tradition grants your choice of one of two abilities.
...
> **Power Roll + Agility:**
>
> - **≤11:** 6 cold damage; A < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 9 cold damage; A < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 13 cold damage; A < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
...
>
> **Effect:** While you have temporary Stamina from this ability, you can't be made [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) even while dying.

### 3rd-Level Features

As a 3rd-level [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you gain the following features.

#### Psionic Leap

You can long [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) and high [jump](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Jump) a distance equal to twice your Agility score without needing to make a test.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, the size of your Null Field ability increases by 1. While the area of that ability is enlarged this way, each enemy who has I < AVERAGE and enters the area for the first time in a combat round or starts their turn there is [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends). Each ally who enters the area for the first time in a combat round or starts their turn there gains temporary Stamina equal to your Intuition score.
...
As a 4th-level [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you gain the following features.
...
As a 5th-level [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you gain the following features.

#### 5th-Level Tradition Feature

Your [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null) tradition grants you a feature, as shown on the 5th-Level Tradition Features table.
...
> **Power Roll + Agility:**
>
> - **≤11:** 7 + A damage; I < WEAK, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 10 + A damage; I < AVERAGE, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 13 + A damage; I < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
>
...
> **Power Roll + Agility:**
>
> - **≤11:** 10 + A damage; A < WEAK, [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
> - **12-16:** 14 + A damage; A < AVERAGE, [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
> - **17+:** 18 + A damage; A < STRONG, [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed)
>
> **Effect:** While [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) this way, the target takes a bane on the Escape Grab maneuver. Each time they use that maneuver, they take damage equal to twice your Agility score.
...
As a 6th-level [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you gain the following features.
...
Your [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null) tradition grants your choice of one of two heroic abilities.
...
As a 7th-level [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you gain the following features.
...
As an 8th-level [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you gain the following features.
...
Your [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null) tradition grants you a feature, as shown on the 8th-Level Tradition Features table.
...
> **Power Roll + Agility:**
>
> - **≤11:** 9 + A damage; push 5; I < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 13 + A damage; push 7; I < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 18 + A damage; push 10; I < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
>
> **Effect:** The target and each creature or object they collide with from this forced movement takes psychic damage equal to the total number of squares the target was force moved. While the target is [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) this way, they see glimpses of creatures from other parts of the timescape.
...
>
> **Effect:** The target takes half the damage, and if the triggering creature has I < AVERAGE, they are [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends). While the triggering creature is [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) this way, they take psychic damage equal to your Intuition score whenever they use a main action.

### 9th-Level Features

As a 9th-level [null](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Null), you gain the following features.

#### I Am the Weapon

Your Stamina increases by 21 and you can't be made [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) even while dying. You no longer age or have need of food. Additionally, you can use Intuition instead of another characteristic when resisting potencies.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 8 + I cold damage; M < WEAK, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 11 + I cold damage; M < AVERAGE, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 15 + I cold damage; M < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
>
> **Effect:** While [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) this way, the target takes cold damage equal to your Intuition score at the start of each of your turns. Additionally, whenever the target damages another creature while [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) this way, any potency associated with the damage is reduced by 2.
...
As a 1st-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.

#### Shadow College

[Shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) colleges are secret institutions that turn ordinary folk into something else. Finding a college is the first step in a rigorous initiation process that tests the mettle of an applicant. Even those who make the cut often wash out—or are kicked out—as the master [shadows](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) who teach stealth, magic, and assassination to their students are often less than gentle in their approach.

You graduated from a [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) college chosen from the following options, each of which grants you a skill. (*Quick Build:* College of Black Ash.)

- College of Black Ash: The College of Black Ash founded the art of being a [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow). Its graduates are unmatched in mobility, using sorcery to [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) around the battlefield, manipulate shadows, and summon darkness. You have the Magic skill.
...
Your [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) college is your subclass, and your choice of college determines many of the features you'll gain as you gain new levels.
...
When you use an ability outside of combat that lets you spend unlimited insight on its effect, such as Black Ash [Teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport), you can use it as if you had spent an amount of insight equal to your Victories.

#### 1st-Level College Features

Your [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) college grants you one or two features, as shown on the 1st-Level College Features table.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to 5 squares. If you have concealment or cover at your destination, you can use the Hide maneuver even if you are observed. If you successfully hide using this maneuver, you gain 1 surge.
>
> **Spend 1+ Insight:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) 1 additional square for each insight spent.
...
Your [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) college grants you a triggered action, as shown on the College Triggered Actions table.
...
> **Trigger:** You take damage.
>
> **Effect:** You take half the damage, then can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to 4 squares after the triggering effect resolves.
>
> **Spend 1+ Insight:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) 1 additional square for each insight spent.
...
> - **≤11:** 3 + A damage
> - **12-16:** 5 + A damage
> - **17+:** 8 + A damage; I < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
>
...
> **Power Roll + Agility:**
>
> - **≤11:** 4 + A damage; A < WEAK, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
> - **12-16:** 6 + A damage; A < AVERAGE, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
> - **17+:** 10 + A damage; A < STRONG, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
...
As a 2nd-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.
...
Your [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) college grants you a feature, as shown on the 2nd-Level College Features table.
...
The ash you leave behind burns your foes. The first time on a turn that you use a [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) ability to [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) away from or into a space adjacent to an enemy, that enemy takes fire damage equal to your Agility score.
...
Your [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) college grants your choice of one of two heroic abilities.
...
> **Power Roll + Agility:**
>
> - **≤11:** 6 + A damage; you can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) the target 1 square
> - **12-16:** 10 + A damage; you can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) the target up to 3 squares
> - **17+:** 14 + A damage; you can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) the target up to 5 squares
...
> - **17+:** 7 poison damage
>
> **Effect:** The gas remains in the area until the end of the encounter. Any creature who starts their turn in the area and has M < AVERAGE is [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends).
...
>
> **Effect:** You use your Clever Trick ability with no insight cost against the triggering creature and strike. You can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) to an unoccupied space within 3 squares of that creature and can make a free strike against them. You can then spend a Recovery.

### 3rd-Level Features

As a 3rd-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.
...
> - **17+:** 18 + A damage
>
> **Effect:** The target is [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) by a willing ally within 5 squares of you until the end of the target's next turn.
...
> **Power Roll + Agility:**
>
> - **≤11:** 8 + A damage; A < WEAK, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **12-16:** 12 + A damage; A < AVERAGE, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
> - **17+:** 16 + A damage; A < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 7 + A damage; M < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 11 + A damage; M < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)
> - **17+:** 16 + A damage; M < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)

### 4th-Level Features

As a 4th-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.
...
As a 5th-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.

#### 5th-Level College Feature

Your [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow) college grants you a feature, as shown on the 5th-Level College Features table.
...
> **Power Roll + Agility:**
>
> - **≤11:** 10 + A damage; P < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 15 + A damage; P < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 21 + A damage; P < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
>
> **Effect:** The target can't communicate with anyone until the end of the encounter.

### 6th-Level Features

As a 6th-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.
...
- You can automatically [climb](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Climb%20or%20Swim) at full speed while moving.
...
> - **12-16:** The creature can [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly) until the end of the encounter.
...
As a 7th-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.
...
As a 9th-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** An enemy takes 6 damage; an ally can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to 3 squares.
> - **12-16:** An enemy takes 10 damage; an ally can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to 5 squares.
> - **17+:** An enemy takes 14 damage; an ally can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to 7 squares.
...
>
> **Effect:** On a critical hit, the target is [grabbed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Grabbed) by the demon and pulled through the portal before it closes, never to be seen again.
...
As a 10th-level [shadow](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Shadow), you gain the following features.
...
**As a [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you have abilities that heal your allies and grant them increased damage, movement, and attacks, even as you leave your enemies struggling to respond.**
...
As a 1st-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
When you use an ability outside of combat that lets you spend unlimited focus on its effect, you can use it as if you had spent an amount of focus equal to your Victories. (Such abilities aren't part of the core rules for the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), but they might appear in future products.)

<!-- -->
> **Tactician Abilities Explained**
>
> Many of the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s abilities grant allies extra movement, damage, and actions. But what's happening in the fiction to allow this? The [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) is an incredible strategist and inspiring leader who is quick to give commands and inspiration that causes their allies to act. The [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician) can quickly read the battlefield, analyze enemies, and then bark orders and encouragement that pushes their allies to greatness. Many of the names of the [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician)'s abilities are the actual commands they give their friends!
...
>
> **Spend 1 Focus:** If the target has R < AVERAGE, they are [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (EoT).
...
For example, if you take the Shining Armor and [Sniper](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Sniper) kits, you gain the following benefits overall:
...
> - If you damage a creature marked by you with a melee ability, the creature is [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) by you until the end of their next turn.
>
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M damage; M < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 5 + M damage; M < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 8 + M damage; M < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 4 + M damage; R < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 6 + M damage; R < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 10 + M damage; R < STRONG, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
...
As a 2nd-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
> **Power Roll + Reason:**
>
> - **≤11:** 5 + R damage; [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) (EoT)
> - **12-16:** 9 + R damage; [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) (EoT)
> - **17+:** 12 + R damage; [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) (EoT)
>
...
> **Power Roll + Might:**
>
> - **≤11:** R < WEAK, the target is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of the triggering ally (save ends)
> - **12-16:** R < AVERAGE, the target is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of the triggering ally (save ends)
> - **17+:** R < STRONG, the target is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of the triggering ally (save ends)
...
As a 3rd-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter or until you are dying, whenever you or any ally deals damage to a target marked by you who has R < AVERAGE, the target is [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) of the creature who dealt the damage (save ends).
...
As a 4th-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
As a 5th-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
> | **📏 3 burst** | **🎯 Self and each ally in the area** |
>
> **Effect:** Each target gains 2 surges. Additionally, they can spend a Recovery, remove any conditions or effects on them, and stand up if they are [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone).
...
As a 6th-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
>
> **Effect:** If the target is hit with two or more strikes as part of this ability and they have R < STRONG, they are [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends). If the target is reduced to 0 Stamina before one or both allies has made their strike, the ally or allies can pick a different target.

### 7th-Level Features

As a 7th-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
As an 8th-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
As a 9th-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
> **Power Roll + Might:**
>
> - **≤11:** R < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** R < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** R < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
...
As a 10th-level [tactician](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Tactician), you gain the following features.
...
Arare few people are born with the potential to harness psionic power, but only those who experience an awakening, a significant event that activates a [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent)'s abilities, can tap into the mind's full potential. You are one of those people—a master of psionics and a source of incredible power created through sheer force of will. You can move and change matter, time, gravity, the laws of physics, or another creature's mind.

**As a [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you are limited only by the strength of your mind. But the ability to wield multiple powers at once and change reality at will involves a gamble. Every manifestation has a chance of harming you, and [talents](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) who use too much power too quickly pay a deadly price.**
...
As a 1st-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.

#### Talent Tradition

Psionic abilities are grouped into categories according to their effects, with each category comprising one of many [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) traditions:
...
You choose a [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) tradition from the following options: chronopathy, telekinesis, or telepathy. Your [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) tradition is your subclass, and your choice of tradition determines many of the features you'll gain as you gain new levels. (Other [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) traditions will be featured in future products.) (*Quick Build:* Telekinesis.)
...
Your [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) tradition grants you two features, as shown on the 1st-Level Tradition Features table.
...
> **Power Roll + Presence:**
>
> - **≤11:** 2 + P corruption damage; P < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 3 + P corruption damage; P < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 5 + P corruption damage; P < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
>
...
> - **≤11:** Slide 2 + R
> - **12-16:** Slide 4 + R
> - **17+:** Slide 6 + R; [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
>
...
>
> **Strained:** The size of the burst increases by 2, and you are [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) until the start of your next turn.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 + R damage; M < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **12-16:** 4 + R damage; M < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **17+:** 6 + R damage; M < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
>
...
> **Power Roll + Presence:**
>
> - **≤11:** 3 + P psychic damage; I < WEAK, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** 6 + P psychic damage; I < AVERAGE, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** 9 + P psychic damage; I < STRONG, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
...
> **Power Roll + Reason:**
>
> - **≤11:** 3 + R damage; M < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 5 + R damage; M < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 8 + R damage; M < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
>
> **Effect:** You can vertical pull the target up to 2 squares. If the target is made [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) by this ability, this forced movement ignores their stability.
...
>
> **Strained:** You take 1d6 damage and are [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends).
...
>
> **Strained:** You are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends). While you are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) this way, whenever you are force moved, the forced movement distance gains a +5 bonus.
...
As a 2nd-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.
...
Your [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) tradition grants you a feature, as shown on the 2nd-Level Tradition Features table.
...
Your [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) tradition grants your choice of one of two heroic abilities.
...
> **Power Roll + Presence:**
>
> - **≤11:** The target's speed is halved (save ends), or if P < WEAK, the target is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends).
> - **12-16:** The target is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends), or if P < AVERAGE, the target's speed is 0 (save ends).
> - **17+:** The target is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends), or if P < STRONG, the target's speed is 0 (save ends).
>
...
>
> **Strained:** The size of the burst increases by 1, and you are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) until the end of your turn.
...
> **Power Roll + Reason:**
>
> - **≤11:** 6 + R damage; M < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **12-16:** 10 + R damage; M < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **17+:** 14 + R damage; M < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (save ends)
>
...
> **Power Roll + Reason:**
>
> - **≤11:** 6 + R psychic damage; I < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 10 + R psychic damage; I < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 14 + R psychic damage; I < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
>
...
>
> **Strained:** You take 1d6 damage and are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) until the end of your turn.

### 3rd-Level Features

As a 3rd-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.
...
> **Power Roll + Presence:**
>
> - **≤11:** 3 + P corruption damage; P < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 5 + P corruption damage; the target is flung through time, and if P < AVERAGE, they are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 8 + P corruption damage; the target is flung through time, and if P < STRONG, they are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
...
> - **17+:** 5 damage
>
> **Strained:** You create five orbs, and you are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) while you have any orbs active.
...
> **Power Roll + Presence:**
>
> - **≤11:** 6 + P damage; P < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** 10 + P damage; P < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** 14 + P damage; P < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
>
...
As a 4th-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.
...
You can [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly). While flying, your stability is reduced to 0 and can't be increased. If you can already [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly), you have a +2 bonus to speed while flying instead.

If you are strained while flying and are force moved, the forced movement distance gains a +2 bonus.

### 5th-Level Features

As a 5th-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.

#### 5th-Level Tradition Features

Your [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) tradition grants you two features, as shown on the 5th-Level Tradition Features table.
...
>
> **Strained:** The target gains 2 surges. You are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) and [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends).
...
>
> **Effect:** You [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) to a square on the opposite side of the area before making the power roll.
>
> **Power Roll + Reason:**
>
> - **≤11:** 12 sonic damage
...
> - **17+:** 24 sonic damage
>
> **Strained:** If you obtain a tier 2 outcome or better, you are [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) until the end of your turn and each target is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) until the end of their turn.
...
> **Power Roll + Reason:**
>
> - **≤11:** 10 + R psychic damage; R < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 14 + R psychic damage; R < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 20 + R psychic damage; R < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
>
> **Effect:** While [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) this way, the target takes 3 psychic damage for each square they willingly leave.
>
> **Strained:** While [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) this way, the target instead takes 5 psychic damage for each square they willingly leave. You have a double bane on ability rolls made against the target while they are [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) this way.
...
As a 6th-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.
...
>
> **Effect:** The area is frozen in time until the start of your next turn. Each object in the area is [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) and can't fall until the effect ends. Until the effect ends, creatures in the area who are reduced to 0 Stamina or would die stay alive, and objects in the area that are reduced to 0 Stamina remain undestroyed.
>
> Make a power roll that targets each enemy in the area.
>
> **Power Roll + Presence:**
>
> - **≤11:** P < WEAK, the target is [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) until the effect ends
> - **12-16:** P < AVERAGE, the target's speed is 0 until the effect ends
> - **17+:** P < STRONG, the target is [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) until the effect ends
>
> **Strained:** Any creature or object force moved in the area takes 2 corruption damage for each square of the area they enter. Creatures and objects [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) in the area can be force moved. You are [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) until the effect ends.
...
> - **17+:** Slide 12 + R; [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone); M < STRONG, the forced movement is vertical
>
> **Strained:** The forced movement ignores stability. You take 2d6 damage and are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends).
...
As a 7th-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.
...
As an 8th-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.
...
Your [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent) tradition grants you two features, as shown on the 8th-Level Tradition Features table.
...
>
> **Effect:** Each target can [fly](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Fly) until the start of your next turn, and can immediately shift up to their speed. You can also shift up to your speed. While flying, a target's stability is reduced to 0 and can't be increased.
>
> **Spend 5 Clarity:** The effects last for 1 hour instead.

##### Low Gravity

Your mind can carry your body through tough times. You ignore difficult terrain and don't need to spend additional movement while [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone).
...
> **Trigger:** The target takes damage.
>
> **Effect:** The target is [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) to an unoccupied space adjacent to you, taking no damage and suffering no additional effects if this movement would get them out of harm's way.
>
...
> **Power Roll + Presence:**
>
> - **≤11:** 10 + P damage; P < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 14 + P damage; P < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 20 + P damage; P < STRONG, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) and [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
>
...
>
> **Strained:** You and the target both permanently grow visibly younger (the equivalent of 20 human years, to the minimum of an 18-year-old). Additionally, you are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) and [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends).
...
- You can't be made [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) or [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened).
...
> **Power Roll + Presence:**
>
> - **≤11:** 4 corruption damage; [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 6 corruption damage; [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 10 corruption damage; [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
...
>
> **Strained:** You are [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends). If you scored a critical hit with this ability, you die.
...
> **Power Roll + Reason:**
>
> - **≤11:** R < WEAK, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** R < AVERAGE, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** R < STRONG, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
>
> **Strained:** You can't use this ability if doing so would cause you to have negative clarity.

### 10th-Level Features

As a 10th-level [talent](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Talent), you gain the following features.
...
The whole world's a stage, and everyone on it, an actor. No one knows this better than the [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour). You find energy in the drama of everyday life and know how to draw spectacle forth from even the most mundane of situations. You accent highs and deepen lows in service to whoever might witness your performance.

**As a [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you chase drama. The insurmountable dangers of the world might cause many a hero to cower. But you take to that world stage not intending to die, but to find out if you are truly alive.**
...
As a 1st-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.

#### Troubadour Class Act

Panache, melody, and depiction. Some [troubadours](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) have it all, but everyone starts somewhere. Your [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act is your art form, summing up the manner in which the world becomes your stage. As you go about unearthing the drama of everyday life and strife, you choose a [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act from the following options, each of which grants you a skill. (*Quick Build:* Virtuoso.)
...
Your [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act is your subclass, and your choice of class act determines many of the features you'll gain as you gain new levels.
...
You can use and gain the benefits of a kit. See Chapter 6: Kits for more information. (*Quick Build:* [Swashbuckler](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Swashbuckler).)
...
Your [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act grants you two features, as shown on the 1st-Level Class Act Features table.
...
>
> **Effect:** At the end of each of your turns while this performance is active, you can choose up to a number of targets equal to your Presence score and [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) those targets to unoccupied spaces in the area. A target can't be [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect.
...
Your [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act grants you a triggered action, as shown on the Class Act Triggered Actions table.
...
> **Power Roll + Presence:**
>
> - **≤11:** 2 + P psychic damage; P < WEAK, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
> - **12-16:** 5 + P psychic damage; P < AVERAGE, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
> - **17+:** 7 + P psychic damage; P < STRONG, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
...
> - **17+:** 9 + P damage
>
> **Effect:** The target is [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) by you or a willing ally adjacent to you until the end of the target's next turn.
...
> **Power Roll + Presence:**
>
> - **≤11:** Slide 1; I < WEAK, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **12-16:** Slide 1; I < AVERAGE, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
> - **17+:** Slide 2; I < STRONG, [dazed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Dazed) (save ends)
>
...
> **Power Roll + Presence:**
>
> - **≤11:** 4 damage; P < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **12-16:** 5 damage; P < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
> - **17+:** 6 damage; P < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (save ends)
>
...
>
> - **≤11:** [Taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) (EoT); A < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **12-16:** [Taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) (EoT); A < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **17+:** [Taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) (EoT); A < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) and can't stand (EoT)
...
> | **📏 3 burst**  | **🎯 Self and each ally in the area** |
>
> **Effect:** Each target can [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) up to 5 squares. Any [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) target who was [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) is no longer [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed).
...
> **Power Roll + Agility:**
>
> - **≤11:** 6 + A damage; P < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 10 + A damage; P < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 14 + A damage; P < STRONG, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
> **Effect:** You can become [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends) to deal an extra 5 corruption damage to the target.

### 2nd-Level Features

As a 2nd-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.
...
Your [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act grants your choice of one of two heroic abilities.
...
As a 3rd-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.

#### 3rd-Level Class Act Feature

Your [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act grants you a feature, as shown on the 3rd-Level Class Act Features table.
...
> **Power Roll + Presence:**
>
> - **≤11:** 5 fire damage; A < WEAK, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **12-16:** 7 fire damage; A < AVERAGE, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
> - **17+:** 10 fire damage; A < STRONG, [weakened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Weakened) (save ends)
>
...
As a 4th-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.
...
As a 5th-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.

#### 5th-Level Class Act Feature

Your [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act grants your choice of one of two features.
...
Once on each of your turns, you can use a free maneuver to change one condition affecting a creature within distance of your Dramatic Monologue ability. Choose one of the following conditions on the target: [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding), [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened), [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed), or [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted). You change that condition to another of those conditions, maintaining the duration and origin of the original condition. A target who is no longer [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) can stand up.
...
As a 6th-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.
...
> **Power Roll + Presence:**
>
> - **≤11:** 2 psychic damage; P < WEAK, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **12-16:** 5 psychic damage; P < AVERAGE, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
> - **17+:** 7 psychic damage; P < STRONG, [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 12 + A damage; M < WEAK, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
> - **12-16:** 18 + A damage; M < AVERAGE, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
> - **17+:** 24 + A damage; [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (EoT), or if M < STRONG, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
...
>
> **Effect:** A [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone) target ignores this ability.
>
> **Power Roll + Presence:**
>
> - **≤11:** 7 sonic damage; P < WEAK, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **12-16:** 10 sonic damage; P < AVERAGE, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
> - **17+:** 13 sonic damage; P < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
...
As a 7th-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.
...
As an 8th-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.
...
Your [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour) class act grants you a feature, as shown on the 8th-Level Class Act Features table.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, whenever you reduce a creature to 0 Stamina using an ability, you can use a free triggered action to [teleport](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) an ally within distance of that ability into the creature's space in a plume of rose petals. You or the [teleported](https://steelcompendium.io/compendium/main-linked/Rules/Movement/Teleport) ally can then make a melee free strike.
...
As a 9th-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.

#### Roar of the Crowd

You are empowered by your audience, near and far. You can't be made [frightened](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Frightened), and if you are [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone), you can stand up as a free maneuver.
...
> - **≤11:** 15 + A damage
> - **12-16:** 21 + A damage
> - **17+:** 28 + A damage; M < STRONG, [bleeding](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Bleeding) (save ends)
>
...
As a 10th-level [troubadour](https://steelcompendium.io/compendium/main-linked/Rules/Classes/Troubadour), you gain the following features.
