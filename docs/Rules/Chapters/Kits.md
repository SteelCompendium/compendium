...
For example, the Shining Armor kit has a +2/+2/+2 melee damage bonus, increasing the damage of melee weapon abilities across all tier outcomes. The [Sniper](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Sniper) kit has a +0/+0/+4 ranged damage bonus, having no effect on a tier 1 or tier 2 outcome on an ability roll, but increasing the damage of tier 3 outcomes by +4 for your ranged weapon abilities.
...
Who says lightly armored heroes can't also be hard to move? You just need to employ some psionics! The [Battlemind](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Battlemind) kit harnesses the power of your mind to make you harder to move—and to make your foes easier to push around.
...
The [Guisarmier](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Guisarmier) kit is for those who want to use a polearm for extended reach while remaining protected by sturdy armor. This is the kit that allows you to become the ultimate halberd, longspear, or glaive fighter.
...
If you want a good balance of protection, speed, and damage, the [Panther](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Panther) kit is for you. This kit increases your Stamina not by wearing armor, but through the focused battle preparation of body and mind, letting you be fast and mobile while swinging a heavy weapon at your foes.
...
Meant for brawlers and boxers, the [Pugilist](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Pugilist) kit gives you access to a melee fighting style that grants a boost to Stamina and damage while allowing you to float like a butterfly. If you want to be a tough, strong hero who doles out punishment with your fists, then this kit is for you.
...
The [Raider](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Raider) kit keeps you protected while granting you full mobility, providing a boost to speed and distance that lets you run around the battlefield like a Viking warrior.
...
The [Ranger](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Ranger) kit outfits you with medium armor and weapons for every challenge, letting you easily switch between melee and ranged combat. This kit provides a good balance of bonuses to defense and offense to create a hero who is a jack-of-all-trades.
...
- **≤11:** 3 + M or A damage; A < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
- **12-16:** 5 + M or A damage; A < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
- **17+:** 7 + M or A damage; A < STRONG, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (save ends)
...
- **≤11:** 4 + M or A damage; A < WEAK, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (EoT)
- **12-16:** 6 + M or A damage; A < AVERAGE, [slowed](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Slowed) (EoT)
- **17+:** 8 + M or A damage; A < STRONG, [restrained](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Restrained) (EoT)
...
**Effect:** The target is [taunted](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Taunted) until the end of their next turn.

#### Sniper

The [Sniper](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Sniper) kit gives you the tools and techniques to take down enemies from afar. This kit can help you become the archer who lurks behind trees or down tunnels, picking off enemies with a bow or crossbow as they approach.
...
If you want to be mobile and deal a lot of damage with melee strikes, then you should reach for the [Swashbuckler](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Swashbuckler) kit. This is a great kit for heroes who want to be master duelists.
...
- **17+:** 9 + M or A damage; push 3; M < STRONG, [prone](https://steelcompendium.io/compendium/main-linked/Rules/Conditions/Prone)
...
The [Whirlwind](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Whirlwind) kit makes effective use of whips, granting you mobility, damage, and reach. If you want to be a fast-moving warrior who lashes foes with a chain or whip, then this is the kit for you.
...
| [Battlemind](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Battlemind)     | Light          | Medium             | +3                  | +2    | +1        | +2/+2/+2     | -             | -              | -               | -         |
| Cloak and Dagger                                                      | Light          | Light              | +3                  | +2    | -         | +1/+1/+1     | +1/+1/+1      | -              | +5              | +1        |
| Dual Wielder                                                          | Medium         | Light, medium      | +6                  | +2    | -         | +2/+2/+2     | -             | -              | -               | +1        |
| [Guisarmier](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Guisarmier)     | Medium         | Polearm            | +6                  | -     | +1        | +2/+2/+2     | -             | +1             | -               | -         |
| Martial Artist                                                        | None           | Unarmed strikes    | +3                  | +3    | -         | +2/+2/+2     | -             | -              | -               | +1        |
| [Mountain](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Mountain)         | Heavy          | Heavy              | +9                  | -     | +2        | +0/+0/+4     | -             | -              | -               | -         |
| [Panther](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Panther)           | None           | Heavy              | +6                  | +1    | +1        | +0/+0/+4     | -             | -              | -               | -         |
| [Pugilist](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Pugilist)         | None           | Unarmed strikes    | +6                  | +2    | +1        | +1/+1/+1     | -             | -              | -               | -         |
| [Raider](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Raider)             | Light, shield  | Light              | +6                  | +1    | -         | +1/+1/+1     | +1/+1/+1      | -              | +5              | +1        |
| [Ranger](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Ranger)             | Medium         | Bow, medium        | +6                  | +1    | -         | +1/+1/+1     | +1/+1/+1      | -              | +5              | +1        |
...
| [Sniper](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Sniper)             | None           | Bow                | -                   | +1    | -         | -            | +0/+0/+4      | -              | +10             | +1        |
| [Spellsword](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Spellsword)     | Light, shield  | Medium             | +6                  | +1    | +1        | +2/+2/+2     | -             | -              | -               | -         |
| Stick and Robe                                                        | Light          | Polearm            | +3                  | +2    | -         | +1/+1/+1     | -             | +1             | -               | +1        |
| [Swashbuckler](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Swashbuckler) | Light          | Medium             | +3                  | +3    | -         | +2/+2/+2     | -             | -              | -               | +1        |
| Sword and Board                                                       | Medium, shield | Medium             | +9                  | -     | +1        | +2/+2/+2     | -             | -              | -               | +1        |
| Warrior Priest                                                        | Heavy          | Light              | +9                  | +1    | +1        | +1/+1/+1     | -             | -              | -               | -         |
| [Whirlwind](https://steelcompendium.io/compendium/main-linked/Rules/Kits/Whirlwind)       | None           | Whip               | -                   | +3    | -         | +1/+1/+1     | -             | +1             | -               | +1        |
